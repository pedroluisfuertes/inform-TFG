...
\newcommand{\mySubTitle}{Extracción y relación de patrones\xspace}
...
\input{capitulos/Motivacion.tex}
\input{capitulos/Objetivos_y_requisitos.tex}
\input{capitulos/Analisis_y_diseno.tex}
