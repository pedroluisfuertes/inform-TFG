...
\begin{itemize}
    \item El coste del equipo utilizado (700\DeclareUnicodeCharacter{20AC}) y una amortización en 2 años.
    \item La mano de obra, que serían 120 días como se ha visto en el apartado de planificación, trabajando 8h al día ya que se va a trabajar a tiempo completo y a 22\DeclareUnicodeCharacter{20AC}/h ya que va a trabajar como autónomo.
    \item El hosting donde se va a desplegar el proyecto que tiene un coste de 120\DeclareUnicodeCharacter{20AC} al año.
\end{itemize}

Sumando todos los costes, el precio final del proyecto serían unos \textbf{21.355\DeclareUnicodeCharacter{20AC}}.
